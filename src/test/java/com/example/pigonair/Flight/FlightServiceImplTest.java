...
class FlightServiceImplTest {
	...
	void getFlightsByConditions() {
		...
		// Test
		Page<FlightResponseDto> result = flightService.getFlightsByConditions(LocalDateTime.now().toString(),
			LocalDateTime.now().plusHours(1).toString(), "LHR", "JFK", 1, 10, "id", "ASC");
